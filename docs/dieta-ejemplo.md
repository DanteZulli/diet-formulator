...
| Nutriente | Objetivo | Total | % MS | % Objetivo |
|-----------|----------|-------|------|------------|
...
- Los valores de "Objetivo" se calculan según los porcentajes elegidos en el perfil del paciente.
- El "% Objetivo" indica el cumplimiento del objetivo: negro = insuficiente, verde = suficiente, rojo = exceso.
